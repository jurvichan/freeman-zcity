...
local teams = {
	[0] = {
		objective = "Tüm Groove üyelerini öldür",
		name = "Bloodz Üyesi",
		color1 = Color(180, 0, 0),
		color2 = Color(180, 0, 0)
	},
	[1] = {
		objective = "Tüm Bloodz üyelerini öldür",
		name = "Groove Üyesi",
...
function MODE:HUDPaint()
	...
	if timeBeforeSWAT > 0 and zb.ROUND_START + 10.5 < CurTime() then
		...
		surface.DrawText(" SWAT gelmeden önce kalan süre!")
	...
	draw.SimpleText("ZBattle | Çete Savaşları", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
