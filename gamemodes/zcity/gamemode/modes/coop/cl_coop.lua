...
local teams = {
	[0] = {
		objective = "Haritanın sonuna git!",
		name = "İsyancı",
...
function MODE:HUDPaint()
	...
	if startTimer > CurTime() then
		...
		surface.DrawText("Oyuncular bekleniyor: ")
    ...
    draw.SimpleText("Cinayet | İşbirliği", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    local Rolename = (lply.role and lply.role.name) or "Bilinmiyor"
    ...
    local Objective = lply.PlayerClassName == "Gordon" and "Direnişi zafere taşı!" or "Gordon'ı takip et!"
