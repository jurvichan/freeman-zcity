...
--
    ...
    draw.SimpleText("Cinayet | Ölüm Maçı", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
CreateEndMenu = function()
	...
	for i,ply in player.Iterator() do
		...
		but.Paint = function(self,w,h)
			...
			surface.DrawText((ply:Name() .. (ply.most_violent_player and " - MVP" or (not ply:Alive() and " - öldü" or ""))))
