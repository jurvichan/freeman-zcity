...
local teams = {
	[0] = {
		objective = "Tüm Combine'ları öldür ve hayatta kal.",
		name = "İsyancı",
		name_refugee = "Mülteci",
	...
	[1] = {
        objective = "Tüm isyancı güçleri yok et.",
        name = "Combine Askeri",
        name_elite = "Seçkin Combine Askeri",
        name_shotgunner = "Combine Pompalıcısı",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("ZBattle | HL2 Ölüm Maçı", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0, 162, 255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    draw.SimpleText("Rolünüz: " .. role_data.name, "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.5, role_data.color, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
