...
local slugcat = {
    objective = "Hayatta kal ve diğerlerini etkisiz hale getir.",
    name = "Slugcat",
...
function MODE:HUDPaint()
    ...
    draw.SimpleText("Arena", "ZB_HomicideMediumLarge", sw * 0.5, sh * 0.1, Color(0,162,255, 255 * fade), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
CreateEndMenu = function()
    ...
    hmcdEndMenu.Paint = function(self,w,h)
		BlurBackground(self)
		local txt = (wonply and wonply:GetPlayerName() or "Nobody").." kazandı!"
