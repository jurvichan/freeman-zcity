...
SWEP.PrintName = "Kan Torbası"
SWEP.Instructions = "Kan gruplamak ve nakletmek için gerekli araçları içeren plastik torba. Büyük kan kayıplarında yardımcı olmak için kullanılabilir."
