...
SWEP.PrintName = "Levye"
SWEP.Instructions = "Levye, yakın dövüş silahı olarak kullanılabilen iki elli bir alettir. Gordon Freeman'ın ikonik imza silahıdır. Kapıları kırabilir.\n\nSOL FARE saldırı.\nSAĞ FARE blok."
