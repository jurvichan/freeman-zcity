...
SWEP.Instructions = "Askeri personel tarafından yakın dövüş silahı veya av aracı olarak kullanılmak üzere tasarlanmış tek elli darbe aleti. Kapıları kırabilir.\n\nSOL FARE saldırı.\nSAĞ FARE blok.\nSAĞ FARE + SOL FARE fırlat."
