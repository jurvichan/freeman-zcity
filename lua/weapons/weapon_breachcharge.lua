...
SWEP.PrintName = "Kapı Kırma Şarjı"
SWEP.Instructions = "Kapalı ve/veya kilitli kapıları zorla açmak için kullanılan patlayıcı cihaz.\n\nKapıya yerleştirmek için SOL FARE."
