...
SWEP.PrintName = "Tıbbi Çanta"
SWEP.Instructions = "Bandaj, ağrı kesici, turnike ve iç kanama ilacı içeren küçük tıbbi çanta. R ile kullanım modunu değiştirin, SAĞ FARE ile başkasına uygulayın."
