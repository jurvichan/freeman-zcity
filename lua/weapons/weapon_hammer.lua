...
SWEP.PrintName = "Çekiç"
SWEP.Instructions = "Küt ve keskin yüzü olan sıradan bir ev çekici. Yolları kapatmak veya birinin hareket etmesini kısıtlamak için kullanın.\n\nSOL FARE saldırı.\nR + SOL FARE saldırı modu değiştir.\nSAĞ FARE blok.\nSAĞ FARE + SOL FARE çivi çak."
