...
SWEP.Instructions = "Fentanil, ağrı kesici olarak kullanılan son derece güçlü sentetik bir opioiddir. Opiat aşırı dozuna yol açabileceğinden doz miktarı kesinlikle gözetilmelidir. Etiket, günlük maksimum dozun yaklaşık %20 olduğunu belirtmektedir. SAĞ FARE ile başkasına enjekte edin."
