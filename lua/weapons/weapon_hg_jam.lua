...
SWEP.PrintName = "Kapı Takozı"
SWEP.Category = "ZCity Other"
SWEP.Instructions = "Ağır hizmet tipi kapı takozu. Bir kapının hareket etmesini durdurmak için kullanılabilir.\n\nKapıyı bloke etmek için SOL FARE.\nTakozu geri almak için E tuşuna basın."
SWEP.Spawnable = true
