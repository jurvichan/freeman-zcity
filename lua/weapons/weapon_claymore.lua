...
SWEP.Instructions = "Claymore, bir rakibin bacaklarını paramparça edebilecek son derece etkili bir mayındır. Kurbanın patlamadan sağ çıkma ihtimali düşüktür."
SWEP.Spawnable = true
