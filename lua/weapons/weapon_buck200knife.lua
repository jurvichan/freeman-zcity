...
SWEP.PrintName = "Buck 120 Bıçağı"
SWEP.Instructions = "Büyük av bıçağı, güçlü kanamaya yol açan kesici delme darbelerine imkan tanıyan kan boşaltma kanalına sahip. Scream filminde katilinin ana silahı olarak kullanılmıştır.\n\nSOL FARE saldırı.\nR + SOL FARE saldırı modu değiştir.\nSAĞ FARE blok."
