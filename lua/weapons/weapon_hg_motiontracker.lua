...
SWEP.PrintName = "Hareket Sensörü"
SWEP.Category = "ZCity Other"
SWEP.Instructions = "Bölgedeki nesnelerin hareketini algılamanızı sağlayan cihaz. Güvenlik personeli için çok kullanışlıdır.\n\nİzinsiz girişçinin kılığını bozan boya şarjı içerir."
SWEP.Spawnable = true
