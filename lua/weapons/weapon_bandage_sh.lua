...
SWEP.PrintName = "Sargı Bezi"
SWEP.Instructions = "Hafif kanamayı durdurmaya yardımcı olabilecek gazlı bez sargısı. Ambalajından çıkarılmış olduğundan steril olma ihtimali düşüktür. SAĞ FARE ile başkasına uygulayın."
...
if CLIENT then
	SWEP.HowToUseInstructions = "<font=ZCity_Tiny>"..string.upper( (input.LookupBinding("+use") or "E") ).." almak için</font>"
end
