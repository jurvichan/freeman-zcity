...
SWEP.PrintName = "Turnike"
SWEP.Instructions = "Büyük (arteryal) kanamaları durdurmak için tasarlanmış turnike. Hafif kanamaları durdurmak için de kullanılabilir; ancak uzvu işlevsiz kılar."
