...
SWEP.Instructions = "Shuriken (fırlatma yıldızı veya ninja yıldızı), samuray veya ninja tarafından dikkat dağıtmak amacıyla kullanılan Japon gizli bir silahtır."
SWEP.Spawnable = true
