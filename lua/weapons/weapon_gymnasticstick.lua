...
SWEP.PrintName = "Jimnastik Sopası"
SWEP.Instructions = "Polis memurlarına isyan kontrolü ve öz savunma için verilen yan saplı cop. Uzun erişimi ve ağırlığı onu şüphelileri etkisiz hale getirmek için etkili kılar.\n\nSOL FARE saldırı.\nSAĞ FARE blok."
