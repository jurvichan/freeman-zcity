...
SWEP.PrintName = "Norepinefrin (Güçlü)"
SWEP.Instructions = "Fury-13 örneklerinden arıtılmış deneysel muharebe uyarıcısı; 'Fury-16' olarak adlandırılmıştır.\n\nVücudunuzu değiştirmek yerine devasa bir hız artışı için tüm kaynaklarını tüketmeye zorlar. Sisteme sentetik noradrenalin pompalayarak aşırı vazokonstrüksiyon ve kalp debisini tetikler."
