...
SWEP.Instructions = "SOL FARE - yumrukları kaldır\nYENİDEN DOLDUR - yumrukları indir\n\nKaldırılmış durumda:\nSOL FARE - vur\nSAĞ FARE - blok\n\nİndirilmiş durumda: SAĞ FARE - nesneyi kaldır, SAĞ FARE+R - nabzı kontrol et (birinin baş veya eline kullanıldığında)\n\nNesne tutarken: YENİDEN DOLDUR - nesneyi havada sabitle, E - nesneyi havada döndür."
SWEP.Spawnable = true
