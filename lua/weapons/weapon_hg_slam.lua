...
SWEP.Instructions = "SLAM (M2/M3/M4), ATK Precision Fuze Company tarafından üretilen küçük çok amaçlı ABD kara mayını. Pasif kızılötesi ve manyetik sensörleri sayesinde demolisyon mühimmatı veya rota dışı mayın olarak kullanılabilir."
SWEP.Spawnable = true
