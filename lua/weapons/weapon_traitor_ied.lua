...
SWEP.PrintName = "El Yapımı Patlayıcı"
SWEP.Instructions = "Küçük bir karton kutuya yerleştirilmiş el yapımı C4 patlayıcı. Tetikleyici eski bir Nokia telefonu. SOL FARE bir nesneye yerleştirmek için, SAĞ FARE bombayu bırakmak için. Yerleştirildikten sonra SOL FARE ile aktive edin."
