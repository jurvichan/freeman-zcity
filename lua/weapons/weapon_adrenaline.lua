...
SWEP.PrintName = "Epinefrin Enjektörü"
SWEP.Instructions = "Adrenalin (epinefrin olarak da bilinir), iç organ fonksiyonlarının düzenlenmesinde görev alan bir hormon ve ilaçtır. Kan basıncını artırmak ve/veya kalp durmasını önlemek için kullanılır. SAĞ FARE ile başkasına enjekte edin."
