...
SWEP.PrintName = "Kanca"
SWEP.Instructions = "Bağlı ip ile ağır çelik kanca. Yüksek/uzak yerlere ulaşmak veya yüksek yerlerden güvenle inmek için kullanın.\n\nSOL FARE sallan/fırlat\nSOL FARE ipi gerdirmek için\nSOL FARE ipi çekmek için\nSAĞ FARE ipi uzatmak için\nR ipi bırakmak için"
