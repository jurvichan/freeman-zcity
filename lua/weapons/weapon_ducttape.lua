...
SWEP.PrintName = "Koli Bandı"
SWEP.Instructions = "Pekiştirilmiş alüminyum renkli su geçirmez polietilen kaplı vinil bez yapışkan bant. Nesneleri birbirine yapıştırmak için kullanın.\n\nBir şeyi yapıştırmak için SOL FARE basılı tut.\nBantı yalnızca iki nesne arasındaki bir dikişe veya boşluğa yapıştırabilirsiniz."
