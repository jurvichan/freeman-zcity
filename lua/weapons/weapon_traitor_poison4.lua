...
SWEP.PrintName = "Curare Flakon"
SWEP.Instructions = "Curare yalnızca bir yaraya bulaştığında veya doğrudan kan dolaşımına girdiğinde etkin hale gelir. İskelet kaslarının zayıflamasına neden olur ve yeterli dozda diyaframın felcinden kaynaklanan asfiksi nedeniyle ölüme yol açar."
