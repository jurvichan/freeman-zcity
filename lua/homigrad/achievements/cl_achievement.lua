...
local function PaintButton(self,w,h)
    surface.SetDrawColor(0, 100, 180, 108)
...
local function PaintFrame(self,w,h)
	BlurBackground(self)
    surface.SetDrawColor(0, 60, 120, 155)
    surface.SetMaterial(gradient_d)
    surface.DrawTexturedRect( 0, 0, w, h )

	surface.SetDrawColor( 0, 100, 180, 128)
...
function hg.DrawAchievmentsMenu(ParentPanel)
    ...
    frame2.Paint = function(self,w,h)
        surface.SetDrawColor(0,60,120,108)
        surface.SetMaterial(gradient_d)
        surface.DrawTexturedRect(0,0,w,h)
...
local ach_clr1 , ach_clr2 = Color(0,100,180), Color(0,60,120)
