...
properties.Add( "break_limb", {
	...
	MenuOpen = function( self, option, ent, tr )
		...
		local spine2 = submenu:AddOption("Omurga 2")
		...
		local spine3 = submenu:AddOption("Omurga 3")
