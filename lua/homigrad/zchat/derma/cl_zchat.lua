...
function PANEL:Paint(w, h)
	...
	DisableClipping(true)
		draw.SimpleText("Sol ALT'ı basılı tut ve ENTER'a bas (fısıltı)", "zChatFontSmall", 5, h * 1.01 + 1, black)
		draw.SimpleText("Sol ALT'ı basılı tut ve ENTER'a bas (fısıltı)", "zChatFontSmall", 4, h * 1.01, gray)
