...
local internalbleed_phrases = {
	"Bu... bu kan mı az önce kustuğum...",
	"Vay be, bu kan...",
	"Kahretsin, kan kusuyorum...",
	"Lanet olsun... hiç iyi değilim...",
}

local about_to_puke = {
	"Her an kusacakmış gibi hissediyorum...",
	"İyi değilim...",
	"Şimdi kusacağım...",
	"Midem bulanıyor...",
}
...
module[2] = function(owner, org, mulTime)
	...
	if org.isPly and not org.otrub and org.blood < 2900 then org.owner:Notify(math.random(2) == 1 and "Hiçbir şey hissetmiyorum..." or (math.random(2) == 1 and "Az kalsın bayılacaktım...") or "Pek iyi değilim...",60,"blood2",0) end
